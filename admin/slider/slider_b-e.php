      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background:black;"><i class="fa fa-caret-square-o-down" ></i> Booking <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="booking_Entry.php" style="color:white;"><i class="fa fa-edit"></i>&nbsp;Booking Entry</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-square-o-down"></i> Customer <b class="caret"></b></a>
              <ul class="dropdown-menu">
