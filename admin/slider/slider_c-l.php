      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background:black;"><i class="fa fa-caret-square-o-down"></i> Check In <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="check_in.php">Check In</a></li>
                <li><a href="check_list.php" style="color:white"><i class="fa fa-edit"></i>&nbsp;Check List</a></li>
